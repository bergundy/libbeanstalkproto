...
Suite *local_suite(void)
{
    ...
    TEST_MSG_WARGS( bsp_gen_put_cmd,                "put 1 2 3 4\r\nbaba\r\n",    1, 2, 3, 4, "baba" );
    TEST_MSG_WARGS( bsp_gen_put_hdr,                "put 1 2 3 4\r\n",            1, 2, 3, 4 );
    TEST_MSG_WARGS( bsp_gen_use_cmd,                "use baba\r\n",               "baba" );
    TEST_MSG(       bsp_gen_reserve_cmd,            "reserve\r\n" );
    TEST_MSG_WARGS( bsp_gen_reserve_with_to_cmd,    "reserve-with-timeout 1\r\n", 1 );
    TEST_MSG_WARGS( bsp_gen_delete_cmd,             "delete 12345\r\n",           12345 );
    TEST_MSG_WARGS( bsp_gen_release_cmd,            "release 12345 3 4\r\n",      12345, 3, 4 );
    TEST_MSG_WARGS( bsp_gen_bury_cmd,               "bury 12345 3\r\n",           12345, 3 );
    TEST_MSG_WARGS( bsp_gen_touch_cmd,              "touch 12345\r\n",            12345 );
    TEST_MSG_WARGS( bsp_gen_watch_cmd,              "watch baba\r\n",             "baba" );
    TEST_MSG_WARGS( bsp_gen_ignore_cmd,             "ignore baba\r\n",            "baba" );
    TEST_MSG_WARGS( bsp_gen_peek_cmd,               "peek 4\r\n",                 4 );
    ...
    TEST_MSG_WARGS( bsp_gen_kick_cmd,               "kick 4\r\n",                 4 );
    TEST_MSG_WARGS( bsp_gen_stats_job_cmd,          "stats-job 4\r\n",            4 );
    TEST_MSG_WARGS( bsp_gen_stats_tube_cmd,         "stats-tube baba\r\n",        "baba" );
    ...
    TEST_MSG_WARGS( bsp_gen_pause_tube_cmd,         "pause-tube baba 2345\r\n", "baba", 2345 );
